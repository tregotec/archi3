...
static key keys[] = {
    ...
    {  ALT ,              XK_Home,       resizestep_aspect, {.i=TWOBWM_RESIZE_KEEP_ASPECT_GROW}},
    {  ALT ,              XK_End,        resizestep_aspect, {.i=TWOBWM_RESIZE_KEEP_ASPECT_SHRINK}},
    ...
    {  MOD ,              XK_f,          fix,               {}},
    // Move the cursor
    {  ALT ,              XK_Up,         cursor_move,       {.i=TWOBWM_CURSOR_UP_SLOW}},
    {  ALT ,              XK_Down,       cursor_move,       {.i=TWOBWM_CURSOR_DOWN_SLOW}},
    {  ALT ,              XK_Right,      cursor_move,       {.i=TWOBWM_CURSOR_RIGHT_SLOW}},
    {  ALT ,              XK_Left,       cursor_move,       {.i=TWOBWM_CURSOR_LEFT_SLOW}},
    // Move the cursor faster
    {  ALT |CONTROL,        XK_Up,         cursor_move,       {.i=TWOBWM_CURSOR_UP}},
    {  ALT |CONTROL,        XK_Down,       cursor_move,       {.i=TWOBWM_CURSOR_DOWN}},
    {  ALT |CONTROL,        XK_Right,      cursor_move,       {.i=TWOBWM_CURSOR_RIGHT}},
    {  ALT |CONTROL,        XK_Left,       cursor_move,       {.i=TWOBWM_CURSOR_LEFT}},
    // Start programs
